...
Börja med att ladda ner [everyloop.bak](https://github.com/everyloop/NEU25G-Databases/tree/master/Resources/everyloop.bak)  och gör en "Restore".
...
funktioner där. Jag har även gjort en sammanställing av [några av de vanligaste funktionerna här!](https://github.com/everyloop/NEU25G-Databases/blob/master/Resources/SQL_functions_overview.md)
